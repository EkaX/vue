                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <div class="pt active" @click="changeImage(thumbs[0])" :class="thumbs[0] == gb_default ? 'active' : '' ">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/ShopingCart" class="primary-btn pd-cart"><i class="fa fa-home"></i> Add To Cart</router-link>
...
import Releated from '@/components/Releated.vue'
